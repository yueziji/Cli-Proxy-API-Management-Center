...
export const TEST_USER_AGENTS = {
  claude: 'claude-cli/2.1.179 (external, cli)',
  codex: 'codex_cli_rs/0.140.0 (Mac OS 26.3.1; arm64) iTerm.app/3.6.9',
  gemini: 'GeminiCLI/0.46.0/unknown (darwin; arm64; terminal)',
  openai: 'OpenAI/Python 2.42.0',
} as const;
